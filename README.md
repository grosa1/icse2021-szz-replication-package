...
- Running B-SZZ. [PySZZ](https://github.com/grosa1/pyszz) (see `tools/pyszz.zip` for a replication snapshot, and check the URL for the latest version) is a free open-source suite of tools used to implement in Python all SZZ major variants.
